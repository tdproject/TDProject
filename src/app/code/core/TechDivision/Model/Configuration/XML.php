...
class TechDivision_Model_Configuration_XML
	...
	protected function __construct($descriptor)
	{
		...
		$this->_beans = new TechDivision_Collections_HashMap();
		...
		TechDivision_Model_Interfaces_Container_Cache $cache)
	{
        ...
        $nodelist = $xpath->query("/container/beans/bean");
        // iterate over the found elements
        foreach ($nodelist as $node) {
            // create a new epb definition
            $cont = new TechDivision_Model_Container_Beans($cache);
            ...
            $this->getBeans()->add($cont->getName(), $cont);
        }
        // get the plugins
	...
	/**
	 * @see TechDivision_Model_Configuration_Interfaces_Container::getBeans()
	 */
