...
class TechDivision_Model_Manager_Transaction
	...
	{
		$this->getContainer()->getMasterManager()->beginTransaction();
		$this->_counter++;
	}
	...
	{
		$this->getContainer()->getMasterManager()->commitTransaction();
		$this->_counter--;
	}
	...
	{
		$this->getContainer()->getMasterManager()->rollbackTransaction();
		$this->_counter--;
	}
}