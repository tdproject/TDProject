...
class TechDivision_Model_Manager_MySQLi
    ...
    /**
     * Prepares the passed query with the parameters and returns it.
     * 
     * @param string $query The query with the placeholders
     * @param array $parameter The array with the parameter values
     * @param array $parameterTypes The array with the parameter types
     * @return string The prepared query
     * @see TechDivision_Model_Manager_MySQLi::_prepare()
     */
    public function prepare($query, $parameter, $parameterTypes)
    {
    	return $this->_prepare($query, $parameter, $parameterTypes);
    }
