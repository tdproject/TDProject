...
class DB_NestedSet {
    ...
    */
    public static function &factory($driver, $dsn, $params = array()) {
    ...
    */
    public function getAllNodes($keepAsArray = false, $aliasFields = true, $addSQL = array()) {
        if ($this->debug) {
    ...
    * @return mixed False on error, or an array of nodes
    */
    public function getRootNodes($keepAsArray = false, $aliasFields = true, $addSQL = array()) {
        if ($this->debug) {
    ...
    * @return mixed False on error, or an array of nodes
    */
    public function getBranch($id, $keepAsArray = false, $aliasFields = true, $addSQL = array()) {
        if ($this->debug) {
    ...
    * @return mixed False on error, or an array of nodes
    */
    public function getParents($id, $keepAsArray = false, $aliasFields = true, $addSQL = array()) {
        if ($this->debug) {
    ...
    */
    public function getParent($id, $keepAsArray = false, $aliasFields = true, $addSQL = array(), $useDB = true) {
        if ($this->debug) {
    ...
    * @return mixed False on error, or the parent node
    */
    public function getSiblings($id, $keepAsArray = false, $aliasFields = true, $addSQL = array()) {
        if ($this->debug) {
    ...
    * @return mixed False on error, or an array of nodes
    */
    public function getChildren($id, $keepAsArray = false, $aliasFields = true, $forceNorder = false, $addSQL = array()) {
        if ($this->debug) {
    ...
    * @return mixed False on error, or an array of nodes
    */
    public function getSubBranch($id, $keepAsArray = false, $aliasFields = true, $addSQL = array()) {
        if ($this->debug) {
    ...
    * @return mixed False on error, or an array of nodes
    */
    public function pickNode($id, $keepAsArray = false, $aliasFields = true, $idfield = 'id', $addSQL = array()) {
        if ($this->debug) {
    ...
    */
    public function isParent($parent, $child) {
        if ($this->debug) {
    ...
    */
    public function createRootNode($values, $id = false, $first = false, $pos = NESE_MOVE_AFTER) {
        if ($this->debug) {
    ...
    * @return mixed The node id or false on error
    */
    public function createLeftNode($id, $values) {
        if ($this->debug) {
    ...
    * @return mixed The node id or false on error
    */
    public function createRightNode($id, $values) {
        if ($this->debug) {
    ...
    */
    public function updateNode($id, $values, $_internal = false) {
        if ($this->debug) {
    ...
    */
    public function moveTree($id, $targetid, $pos, $copy = false) {
        if ($this->debug) {
    ...
    * @see _moveCleanup
    */
    protected function _moveAcross($source, $target, $pos, $first = false) {
        if ($this->debug) {
    ...
    * @access private
    */
    protected function _moveCleanup($copy = false) {
    ...
    * @see moveTree
    */
    protected function _moveRoot2Root($source, $target, $pos) {
        if ($this->debug) {
    ...
    * @access private
    */
    protected function _secSort($nodeSet) {
    ...
    protected function _secSortCollect($segment, $deepArray, $reset = false) {
    ...
    */
    protected function _addSQL($addSQL, $type, $prefix = false) {
    ...
    */
    protected function _getSelectFields($aliasFields) {
        $queryFields = array();
        foreach ($this->params as $key => $val) {
    ...
    */
    protected function _processResultSet($sql, $keepAsArray, $fieldsAreAliased) {
    ...
    * @access private
    */
    protected function _testFatalAbort($errobj, $file, $line) {
    ...
    * @access private
    */
    protected function _raiseError($code, $mode, $option, $epr = array()) {
    ...
    * @access public
    */
    public function triggerEvent($event, & $node, $eparams = false) {
    ...
    */
    public function setsortMode($sortMode = false) {
    ...
    * @return void
    */
    public function setDbOption($option, $val) {
    ...
    */
     ...
     * @access private
     */
    protected function _setLock($exclusive = false) {
        $lock = $this->testLock();
     ...
     * @access private
     */
    protected function _releaseLock($exclusive = false) {
        if ($this->debug) {
     ...
     * @access private
     */
    protected function _values2UpdateQuery($values, $addval = false) {
        if ($this->debug) {
     ...
     * @access private
     */
    protected function _values2InsertQuery($values, $addval = false) {
        if ($this->debug) {
     ...
     * @return void
     */
    protected function _verifyUserValues($caller, & $values) {
        if ($this->_dumbmode) {
            return true;
        }
     ...
     */
    protected function convertTreeModel(& $orig, & $copy, $_parent = false) {
        static $firstSet;
        $isRoot = false;
        if (!$_parent) {
